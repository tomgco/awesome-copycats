...
local graphics   = "gimp"
local tagnames   = { "term", "web", "im", "media", "files", "other" }
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ }, "XF86AudioRaiseVolume", function ()
       awful.util.spawn("ponymix --max-volume 200 increase 10") end),
    awful.key({ }, "XF86AudioLowerVolume", function ()
       awful.util.spawn("ponymix --max-volume 200 decrease 10") end),
    awful.key({ }, "XF86AudioMute", function ()
       awful.util.spawn("ponymix toggle") end),
